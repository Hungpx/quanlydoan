...
<div id="content">
  <div id="content-header">
    ...
    <a href="#" class="current">Thêm mới bài viết</a>
    </div>
  </div>
          ...
          <div class="widget-content nopadding">
          	<form action="" method="post"  enctype="multipart/form-data"  class="form-horizontal" name="basic_validate" id="basic_validate" novalidate="novalidate">
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="tieude"  id="tieude" class="span11" placeholder="Tiêu đề" /><span class="required">(*)</span>
                  </div>
                </div>
                  ...
                  <div class="controls">
                     ...
                     <?php 
                        foreach ($dsMenu as $menu){
                            echo '<option value="'.$menu->getId().'">'.$menu->getTenMenu().'</option>';
                        }
                     ?>
                    </select>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                  	<textarea name="mota" class=" span8" rows="6" placeholder="Mô tả ..."></textarea>
                  	<span class="required">(*)</span>
                  </div>
                 </div>
                 <div class="control-group">
                  ...
                  <div class="controls">
                  	<textarea name="chitiet" class="textarea_editor span8" rows="10" placeholder="chi tiết bài viết..."></textarea>
                  	<span class="required">(*)</span>
                  </div>
                 </div>
