...
<div id="content">
  <div id="content-header">
    ...
    <a href="#" class="current">Thêm mới chủ đề</a>
    </div>
  </div>
          ...
          <div class="widget-content nopadding">
          	<form action="" method="post" class="form-horizontal" name="basic_validate" id="basic_validate" novalidate="novalidate">
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="maChude" id="maChude" class="span11" placeholder="Mã chủ đề" /><span class="required">(*)</span>
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Tên chủ đề:</label>
                  <div class="controls">
                    <input type="text" name="tenChude" id="requried" class="span11" placeholder="Tên chủ đề" /><span class="required">(*)</span>
                  </div>
                </div>
